...
BASIC_STOPWORDS: List[str] = ["de", "of", "and", "&"]
...
COMPANY_STOPWORDS_BROAD: List[str] = [
    "Development",
    "Financial",
    "Investment",
    "Investments",
]
ORG_TYPES: List[Dict[str, Any]] = [
    {
        "display": "PLC",
        "compare": "JSC",
        "aliases": [
    ...
    {"display": "Soc.Col.", "compare": "GP", "aliases": ["Sociedad Colectiva"]},
    {
        "display": "S.C.e I.",
        "compare": "scei",
        "aliases": [
    ...
    {"display": "ASC", "aliases": ["açıq səhmdar cəmiyyəti"]},
