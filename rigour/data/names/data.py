...
ORG_SYMBOLS: Dict[str, Tuple[str, ...]] = {
    ...
    "SERVICE": ("service", "services", "servicios", "обслуживания", "служба", "службы"),
    "DEFENCE": (
        "Verteidigung",
        "defence",
        "defensa",
    ...
    "OIL": ("neft", "oil", "petroleum", "нефть", "нефтяной"),
    "STEEL": (
        "metallurgical",
        "metallurgy",
        "steel",
    ...
    "SECURITY": ("güvenlik", "security", "seguridad", "sécurité", "безопасности"),
    "GLOBAL": (
        "global",
        "globalny",
        "globální",
