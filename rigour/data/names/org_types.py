...
ORG_TYPES: List[OrgTypeSpec] = [
    ...
    {"display": "BV", "generic": "LLC", "aliases": ["B.V.", "besloten vennootschap"]},
    {
        "display": "bvba",
        "generic": "LLC",
        "aliases": [
    ...
    {"display": "ONG", "generic": "NGO", "aliases": ["organização não governamental"]},
    {
        "display": "ood",
        "generic": "LLC",
        "aliases": [
    ...
    {"display": "ОО", "generic": "NGO", "aliases": ["ОБЩЕСТВЕННАЯ ОРГАНИЗАЦИЯ"]},
    {
        "display": "НОУ ДПО",
        "generic": "NGO",
        "aliases": [
